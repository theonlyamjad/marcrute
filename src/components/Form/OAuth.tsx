...
const OAuth = ({ text_1, text_2 }: OauthType) => {
  return (
    ...
    <div className="flex w-full flex-col-reverse justify-around gap-3 md:flex-row lg:flex-row ">
        <div  className="hover:inset-shadow-md flex w-full cursor-pointer items-center gap-2 rounded-md border p-2 font-medium transition-all duration-300 hover:bg-slate-50 dark:border-gray-300">
            ...
            <hr className="h-6 rounded-md border" />
            <p>{text_1}</p>
        </div>
